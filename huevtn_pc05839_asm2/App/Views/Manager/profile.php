                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card mb-4">
                            ...
                            $userID = $data['userID'];
                            ?>
                            <form method="post" action="<?= ROOT_URL ?>?url=ProfileContronller/uploadIMG/<?=$userID?>" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-8">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form method="post" action="<?= ROOT_URL ?>?url=ProfileContronller/editInfor/<?= $data['userID'] ?>">
                                    <div class="row">
                                        <div class="col-sm-3">
