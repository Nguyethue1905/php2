                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="post" action="<?=ROOT_URL?>?url=LoginController/submit">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <a href="<?= ROOT_URL ?>?url=ForgotController/forgot">Forgot Password</a>
                            </div>
                            <button type="submit" name="submit" class="btn btn-primary py-3 w-100 mb-4">Sign In</button>
                            <p class="text-center mb-0">Don't have an Account? <a href="<?= ROOT_URL ?>?url=LoginController/signup">Sign Up</a></p>
                        </form>
                    </div>
                </div>
            </div>
