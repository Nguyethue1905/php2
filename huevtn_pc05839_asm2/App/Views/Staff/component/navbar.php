...
<div class="content">
    ...
    <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
        ...
        <form class="d-none d-md-flex m-2 p-0" action="<?=ROOT_URL?>?url=WorkController/SearchWorkStaff" style="height:40px;" method="post">
        ...
        <div class="navbar-nav align-items-center ms-auto">
            <div class="nav-item dropdown">
                <a href="<?= ROOT_URL ?>?url=HomeController/homePageStaff" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                    <a href="<?=ROOT_URL?>?url=ProfileContronller/indexStaff" class="dropdown-item">My Profile</a>
